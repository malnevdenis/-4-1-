    ...
    public partial class otchet2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                SqlDataAdapter da = new SqlDataAdapter(@"Select o.наименование, s.Должность, ok.зарплата
                ...
                join Оклад as ok on s.код_сотрудника = ok.код_сотрудника
