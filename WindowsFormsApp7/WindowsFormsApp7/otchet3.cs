    ...
    public partial class otchet3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                SqlDataAdapter da = new SqlDataAdapter(@"Select o.наименование, s.Должность, b.дата_начала, b.дата_окончания 
                from Сотрудники as s
                join Информация_о_сотруднике as inf on s.код_сотрудника = inf.код_сотрудника
                join Отделы as o on s.код_отдела = o.код_отдела
                join Больничный as b on s.код_сотрудника = b.код_сотрудника
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            _excelCells1.Value = "Отчет об окладах";
            ...
            ExcelApp.Cells[8, 1] = "Название отдела";
            ExcelApp.Cells[8, 2] = "Должность";
            ExcelApp.Cells[8, 3] = "Дата начала";
            ExcelApp.Cells[8, 4] = "Дата окончания";
